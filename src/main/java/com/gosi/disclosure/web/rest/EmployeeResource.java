...
/**
 * REST controller for managing {@link com.gosi.disclosure.domain.Employee}.
 */
@RestController
    ...
    public ResponseEntity<Employee> partialUpdateEmployee(
        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(existingEmployee -> {
                ...
                if (employee.getLocalPhone() != null) {
                    existingEmployee.setLocalPhone(employee.getLocalPhone());
                }
                if (employee.getDepartment() != null) {
                    existingEmployee.setDepartment(employee.getDepartment());
                }
                if (employee.getPhysicalDeliveryOfficeName() != null) {
                    existingEmployee.setPhysicalDeliveryOfficeName(employee.getPhysicalDeliveryOfficeName());
                }
                if (employee.getDistinguishedName() != null) {
                    existingEmployee.setDistinguishedName(employee.getDistinguishedName());
                }

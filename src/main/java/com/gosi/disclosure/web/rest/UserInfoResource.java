...
/**
 * REST controller for managing {@link com.gosi.disclosure.domain.UserInfo}.
 */
@RestController
        ...
        Optional<UserInfo> result = userInfoRepository
            ...
            .map(existingUserInfo -> {
                if (userInfo.getLoginName() != null) {
                    existingUserInfo.setLoginName(userInfo.getLoginName());
                }
                ...
                if (userInfo.getKey() != null) {
                    existingUserInfo.setKey(userInfo.getKey());
                }
                if (userInfo.getName() != null) {
                    existingUserInfo.setName(userInfo.getName());
                }
                if (userInfo.getJobTitle() != null) {
                    existingUserInfo.setJobTitle(userInfo.getJobTitle());
                }
                if (userInfo.getJobNumber() != null) {
                    existingUserInfo.setJobNumber(userInfo.getJobNumber());
                }
                if (userInfo.getExt() != null) {
                    existingUserInfo.setExt(userInfo.getExt());
                }
                if (userInfo.getPublicAdministration() != null) {
                    existingUserInfo.setPublicAdministration(userInfo.getPublicAdministration());
                }
                if (userInfo.getAdministration() != null) {
                    existingUserInfo.setAdministration(userInfo.getAdministration());
                }
                if (userInfo.getRelativeRelationship() != null) {
                    existingUserInfo.setRelativeRelationship(userInfo.getRelativeRelationship());
                }
                if (userInfo.getOffice() != null) {
                    existingUserInfo.setOffice(userInfo.getOffice());
                }

...
import { sampleWithRequiredData } from '../gift.test-samples';
...
describe('Gift Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.gifts()[0]).toEqual(expect.objectContaining({ id: 17243 }));
  });

  describe('trackId', () => {
    it('should forward to giftService', () => {
      const entity = { id: 17243 };
      jest.spyOn(service, 'getGiftIdentifier');
      const id = comp.trackId(entity);
      expect(service.getGiftIdentifier).toHaveBeenCalledWith(entity);
